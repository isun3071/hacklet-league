...
export default function AboutPage() {
  return (
    <main className="container block">
      ...
      <p className="body">{`HackLet aims to have three tiers of events. Starting with tier C, the entry-level tier, equivalent to hackathons. Anyone can run these, and it lasts no longer than an hour-long club meeting. At tier B, events use AI models that HackLet provides, with written attestation of anti-cheating codes. And at tier A, events use controlled workstations with results feeding into global rankings; tier A is also the only tier we broadcast, though a tier A event does not have to be televised. The higher the tier, the more rigorous the verification, and therefore, the more reliable an achievement there is.`}</p>
