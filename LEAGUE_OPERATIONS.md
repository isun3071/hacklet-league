...
- Costs are low at current model pricing ($0.09/M input, $0.18/M output as of 2026-08-03), so a 40-player round costs single-digit to low-tens of dollars even with every player at the ceiling
