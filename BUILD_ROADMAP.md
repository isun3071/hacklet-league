...
- **The docs were reconciled 2026-07-28 through 07-31.** DOC_STATE.md audits every section's status and lists contradictions `C-01`…`C-22`; DECISIONS_OWED.md holds the open calls. Both are **snapshots with correction headers**, not live documents — read the header before trusting a row. Nine contradictions have been closed since the audit ran.
