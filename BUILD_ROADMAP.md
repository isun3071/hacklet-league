...
## Status & Deviations (as of 2026-07-26)
...
- **Stage 4 (AI Substrate) is the active stage.** No substrate code exists yet — no `ai_proxy` app, no OpenRouter integration, no player portal route.
